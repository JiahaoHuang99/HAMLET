...
from train.train_diffusion_reaction_2d_d3_m21 import train_epoch, evaluate_epoch
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default="config/DiffusionReaction2D/PDEBench/config_DR2D_PDEBench_M21b_D3_PNG_Customx4_Customx4_Tx1_RelPE_InitO_BN_MSE_BS4_r0.08_OCLR1.json", help="json configuration file")
