...
from train.train_shallow_water_2d_d3_m21 import evaluate_1step
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default="config/ShallowWater2D/PDEBench/test/config_test_SW2D_PDEBench_M21b_LEncDep6Chnl_D3_PNG_Customx1_Customx1_Tx1_RelPE_InitO_BN_MSE_OCLR1.json", help="json configuration file")
