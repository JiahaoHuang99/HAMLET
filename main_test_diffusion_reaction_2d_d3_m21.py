...
from train.train_diffusion_reaction_2d_d3_m21 import evaluate_1step
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default="config/DiffusionReaction2D/PDEBench/test/config_test_DR2D_PDEBench_M21b_LEncDep6Chnl_D3_PNG_Customx1_Customx1_Tx1_RelPE_InitO_BN_MSE_BS4_r0.08_OCLR1.json", help="json configuration file")
